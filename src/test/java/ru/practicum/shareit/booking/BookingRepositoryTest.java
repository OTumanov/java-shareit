...
public class BookingRepositoryTest {
    ...
    public void beforeEach() {
        ...
        booking = bookingRepository
                .save(new Booking(null, item, booker, bookingStatus, start, end));
    }
    ...
    void findBookingsForAddCommentsTest() {
        List<Booking> result = bookingRepository.findBookingsForAddComments(item.getId(), booker.getId(), end.plusDays(1));
